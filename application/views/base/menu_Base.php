    ...
    <nav class=" nav-extended">
        <div class="nav-wrapper">
            ...
            <ul class="right hide-on-med-and-down">
                <li><a href="<?= base_url() ?>index.php/index"><img height="32px" src="<?= base_url() ?>recursos/imagenes/redes/facebook.png" alt=""></a></li>
                <li><a href="<?= base_url() ?>index.php/index"><img height="32px" src="<?= base_url() ?>recursos/imagenes/redes/instagram.png" alt=""></a></li>
            </ul>
        </div>
...
<ul id="slide-out" class="sidenav">
    ...
    <li><a href="<?= base_url() ?>index.php/index"><img height="32px" class="material-icons" src="<?= base_url() ?>recursos/imagenes/redes/facebook.png" alt=""></a></li>
    <li><a href="<?= base_url() ?>index.php/index"><img height="32px" src="<?= base_url() ?>recursos/imagenes/redes/instagram.png" alt=""></a></li>
</ul>