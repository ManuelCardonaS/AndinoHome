<div id="modal_Crear_Producto" class="modal modal-fixed-footer" style="height: 90%; width: 80%;">
    ...
    <div class="modal-footer">
        ...
        <a id="btn_Cancelar_Producto" href="#!" class="waves-effect waves-green btn btn-small red">Cancelar</a>
        <a id="btn_Cerar_Crear_Producto" href="#!" class="modal-close waves-effect waves-green btn btn-small right">Cerrar</a>
    </div>
</div>